...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='GDLoss', loss_type='gwd', loss_weight=0),
        loss_overlap=dict(
            type='GaussianOverlapLoss', loss_weight=0, lamb=0),
        loss_voronoi=dict(
            type='VoronoiWatershedLoss', loss_weight=5.0),
        loss_bbox_edg=dict(
            type='EdgeLoss', loss_weight=0),
        loss_ss=dict(
            type='Point2RBoxV2ConsistencyLoss', loss_weight=0),
        loss_naoa=dict(
            type='NAOALoss',
